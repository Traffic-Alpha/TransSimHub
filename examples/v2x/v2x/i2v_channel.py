'''
@Author: WANG Maonan
@Date: 2024-08-09 21:29:37
@Description: I2V Channel (和 V2I 唯一区别就是 get_snr 参数不一样)
@LastEditTime: 2024-08-09 21:31:56
'''
...
if __name__ == '__main__':
    ...
    for _ in range(time_steps):
        ...
        snr = v2i_channel.get_snr(
            previous_vehicle_pos, current_vehicle_pos, 
            is_ms_transmit=False, is_ms_received=True # I2V
        )
        snr_list.append(snr)        
