...
LastEditTime: 2025-04-15 12:07:14
'''
import random
...
if __name__ == '__main__':
    ...
    for _ in range(10):
        ...
        while not done:
            ...
            show_sensor_images(
                [
                    sensor_data.get('-E1__0__police.0', {}).get('front_left_all', None),
                    sensor_data.get('-E1__0__police.0', {}).get('front_all', None),
                    sensor_data.get('-E1__0__police.0', {}).get('front_right_all', None),

                    sensor_data.get('-E1__0__police.0', {}).get('back_left_all', None),
                    sensor_data.get('-E1__0__police.0', {}).get('back_all', None),
                    sensor_data.get('-E1__0__police.0', {}).get('back_right_all', None),

                    sensor_data.get('-E1__0__police.0', {}).get('front_left_vehicle', None),
                    sensor_data.get('-E1__0__police.0', {}).get('front_vehicle', None),
                    sensor_data.get('-E1__0__police.0', {}).get('front_right_vehicle', None),

                    sensor_data.get('-E1__0__police.0', {}).get('back_left_vehicle', None),
                    sensor_data.get('-E1__0__police.0', {}).get('back_vehicle', None),
                    sensor_data.get('-E1__0__police.0', {}).get('back_right_vehicle', None),
                    
                    sensor_data.get('-E1__0__police.0', {}).get('bev_all', None),
                    sensor_data.get('-E1__0__police.0', {}).get('bev_vehicle', None)
                ],
                scale=0.5,
                images_per_row=3
            ) # 展示 ego 车辆的视角
