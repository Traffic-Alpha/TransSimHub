...
@LastEditTime: 2023-09-06 20:12:49
'''
...
class TSCAgent:
    ...
    def agent_run(self, tls_id:str, sim_step:float):
        logger.info(f"SIM: Decision at step {sim_step} for traffic light {tls_id} is running:")
        r = self.agent.run(
