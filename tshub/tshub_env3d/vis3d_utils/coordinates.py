'''
@Author: WANG Maonan
@Date: 2024-07-03 16:21:26
@Description: Reference link, https://github.com/huawei-noah/SMARTS/blob/master/smarts/core/coordinates.py
@LastEditTime: 2024-07-09 00:04:30
'''
...
class Pose:
    ...
    """Center of vehicle."""
    orientation: np.ndarray  # [a, b, c, d] -> a + bi + cj + dk = 0, 方向
