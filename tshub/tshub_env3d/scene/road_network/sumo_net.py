...
@Description: 将 SUMO 路网解析为道路几何 (路面多边形 / 车道线); 入口见 scene.scene_export
...
from tshub.tshub_env3d.core.utils.coordinates import BoundingBox, Point

# 地图元素
from .map_elements.base_road_map import RoadMap
from .geometry import buffered_shape
