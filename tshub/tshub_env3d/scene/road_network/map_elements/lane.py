...
from tshub.tshub_env3d.core.utils.coordinates import Point, Pose, RefLinePoint, BoundingBox
...
class Lane(RoadMap.Lane, Surface):
    ...
    def width_at_offset(self, offset: float) -> Tuple[float, float]:
        # offset 未使用是刻意的: SUMO 的车道等宽, 无论沿车道走到哪宽度都一样 (置信度 1.0).
        # 签名必须与 RoadMap.Lane.width_at_offset 保持一致, 不能删这个参数.
